...
describe('MESSAGE CRITERIA', () => {
    ...
    // CHECK MESSAGE CRITERIA 2
    describe(`Message criteria 2`, () => {
        it('Criteria should NOT be fulfilled', async () => {
            let messageObj = {
                message: 'hej',
                key: 'SEKReYDZ2HwLUNdAy8WTDm8bPDywbRfokQyJe8CUJ6J4eMQ6y4FEaKP8DdTyW5qBif3YJUrgg3UGPKLwXj7G68bn1sT32FSDmbu',
                signature: '63397036af2d08dd9a979bce71409ebed2df5dfdd98e99c31652321afdb8d20431f8139b5798cec9fd60287c7c99c7b77382698511be211a89118862ae895707',
            ...
            assert.equal(actualCriteriaFulfilled, false)
        })
    })

    // CHECK MESSAGE CRITERIA 3
    describe(`Message criteria 3`, () => {
        it('Criteria should NOT be fulfilled', async () => {
            let messageObj = {
                message: 'hej',
                key: 'SEKReYDZ2HwLUNdAy8WTDm8bPDywbRfokQyJe8CUJ6J4eMQ6y4FEaKP8DdTyW5qBif3YJUrgg3UGPKLwXj7G68bn1sT32FSDmbu',
    ...
    // CHECK MESSAGE CRITERIA 4
    describe(`Message criteria 4`, () => {
        it('Criteria should NOT be fulfilled', async () => {
            let messageObj = {
                message: 'home',
                key: 'SEKReYDZ2HwLUNdAy8WTDm8bPDywbRfokQyJe8CUJ6J4eMQ6y4FEaKP8DdTyW5qBif3YJUrgg3UGPKLwXj7G68bn1sT32FSDmbu',

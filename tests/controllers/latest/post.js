...
describe('POST API ENDPOINTS', () => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}v2/posts/latest`, () => {
        it('It should return all latest posts', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}v2/posts/latest`)
    ...
    // GET ALL POSTS
    describe(`GET ${process.env.API_BASE_PATH}v2/posts`, () => {
        it('It should return all posts', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}v2/posts`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}v2/posts/latest?size=3&page=0`, () => {
        it('It should return all posts', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}v2/posts/latest?size=3&page=0`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    // GET POST BY TX HASH
    describe(`GET ${process.env.API_BASE_PATH}v2/posts/57a2c0bb62f6ea2521fe214e89bd52dc2433cbe597b5632c7aef73d0bc2496e7`, () => {
        it('It should return 1 post with a specific tx hash', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}v2/posts/57a2c0bb62f6ea2521fe214e89bd52dc2433cbe597b5632c7aef73d0bc2496e7`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {

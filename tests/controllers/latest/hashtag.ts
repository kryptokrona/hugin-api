...
describe('HASHTAG API ENDPOINTS', () => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags/latest`, () => {
        it('It should return the latest hashtags', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags/latest`)
    ...
    // GET ALL HASHTAGS
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags`, () => {
        it('It should return all hashtags', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags/trending`, () => {
        it('It should return all trending hashtags', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags/trending`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    // GET HASHTAG BY ID
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags/1`, () => {
        it('It should return a hashtag with ID of 1', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags/1`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags/1000`, () => {
        it('It should not return a hashtag', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags/1000`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(404)
                .then(response => {
    ...
    describe(`GET ${process.env.API_BASE_PATH}/v2/hashtags?search=krona`, () => {
        it('It should return a hashtag with name kryptokrona', async () => {
            return request(server)
                .get(`${process.env.API_BASE_PATH}/v2/hashtags?search=krona`)
                .set('Accept', 'application/json')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {

...
describe('POST ENCRYPTED API ENDPOINTS', () => {
  ...
  describe(`GET ${process.env.API_BASE_PATH}/v1/posts-encrypted-group/latest`, () => {
    it('It should return all latest encrypted posts', async () => {
      return request(server)
        .get(`${process.env.API_BASE_PATH}/v1/posts-encrypted-group/latest`)
  ...
  describe(`GET ${process.env.API_BASE_PATH}/v1/posts-encrypted`, () => {
    it('It should return all encrypted posts', async () => {
      return request(server)
        .get(`${process.env.API_BASE_PATH}/v1/posts-encrypted-group`)
        .set('Accept', 'application/json')
        .expect('Content-Type', /json/)
        .expect(200)
        .then(response => {
  ...
  describe(`GET ${process.env.API_BASE_PATH}/v1/posts-encrypted-group/c077967136518addd60ec558275aa8066aa1e17280423e405cd570e405a0e00f`, () => {
    it('It should return 1 encrypted post with a specific tx hash', async () => {
      return request(server)
        .get(`${process.env.API_BASE_PATH}/v1/posts-encrypted-group/c077967136518addd60ec558275aa8066aa1e17280423e405cd570e405a0e00f`)
        .set('Accept', 'application/json')
        .expect('Content-Type', /json/)
        .expect(200)
        .then(response => {
  ...
  describe(`GET ${process.env.API_BASE_PATH}/v1/posts-encrypted-group/57a2c0bb62f6ea2521fe214e89bd52dc2433cbe597b5632c7aef73d0bc2496e3`, () => {
    it('It should NOT return 1 encrypted post with a specific tx hash', async () => {
      return request(server)
        .get(`${process.env.API_BASE_PATH}/v1/posts-encrypted-group/57a2c0bb62f6ea2521fe214e89bd52dc2433cbe597b5632c7aef73d0bc2496e3`)
        .set('Accept', 'application/json')
        .expect('Content-Type', /json/)
        .expect(404)
        .then(response => {
